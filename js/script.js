    ...
    pokemonList.forEach(function(pokemon) {
            console.log("Name:" + pokemon.name + '<br>' + "Height (m):" + " " +       pokemon.height + '<br>' + "Type:" + " " + pokemon.type + '<br>');
            //logs name, height, and type into console
            document.write("Name:" + pokemon.name + '<br>' + "Height (m):" + " " +       pokemon.height + '<br>' + "Type:" + " " + pokemon.type + '<br>');
            //writes name, height, and type onto document
    ...
    if (pokemon.height < 1.5 && pokemon.height >= 0.5){
        document.write (
            ...
            document.write (pokemon.name + " is a small sized pokemon" + '<br><br>');
